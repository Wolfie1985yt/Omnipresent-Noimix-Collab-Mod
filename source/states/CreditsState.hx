...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Estaguy',				'Estaguy',			'Made the Icon and Logo For the Mod, RoSE Artist',			'https://youtube.com/@Estaguy24',																'c20007'],
			...
			['Mr. Half',			'half',				'Charter',													'https://youtube.com/@mr_half?si=o1tNdtZvDyG3jB6V',												'ffffff'],
			...
			['Revie',				'revie',			'Owner of Faker and Former Director of VS Sonic.EXE',		'https://x.com/_revie03?lang=en',																'aaaaaa'],
			...
			['Sulonam',				'Sulonam',			'Co-Director of Restoration of Sonic.EXE',					'https://www.youtube.com/@MMMandComino',														'e34c00'],
